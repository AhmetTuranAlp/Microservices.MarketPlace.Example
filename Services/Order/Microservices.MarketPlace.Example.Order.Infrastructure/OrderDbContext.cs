...
namespace Microservices.MarketPlace.Example.Order.Infrastructure
{
    public class OrderDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Domain.OrderAggregate.Order>().OwnsOne(o => o.Address).WithOwner();//Owned Entity Types
